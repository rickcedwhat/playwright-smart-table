...
What works today might not work tomorrow — a column moves, data pages over, or rows virtualize out of the DOM. And every table is different: semantic `<table>` is the exception, not the rule.
