 ...
 *
 * Config generated by the MCP inspector and verified working.
 * Selector: #demo-_R_1id9l7aqll6_ (React-generated stable ID for this table on this page build).
...
// React-generated ID — stable for this page build, may change on MUI version bumps
const GRID_SELECTOR = '#demo-_R_1id9l7aqll6_';
